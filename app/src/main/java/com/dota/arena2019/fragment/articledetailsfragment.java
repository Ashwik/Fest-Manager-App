    ...
    private String getArticles(int id){
        ...
        switch (id) {
            case 0:
                ...
                break;
            case 1: text="Rising importance of sports culture in technical institutions:-\n" +
            ...
            case 2: text="The Sports Secretary Interview:-\n" +
